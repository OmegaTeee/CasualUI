namespace ProjectTools.PresetsPerFolder {
   ...
   /// </summary>
    public class EnforcePresetPostProcessor : AssetPostprocessor
    {
        void OnPreprocessAsset()
        {
            ...
            // The IsValidFolder ensures that we do not consider folders themselves in this process.
        ...
        /// It is very important to set all the hashes correctly at startup
    ...
    public class UpdateFolderPresetDependency : AssetsModifiedProcessor
    {
        ...
        /// These methods determine if any Preset has been added, removed, or moved
        ...
        protected override void OnAssetsModified(string[] changedAssets, string[] addedAssets, string[] deletedAssets, AssetMoveInfo[] movedAssets)
        {
            ...
            if (folders.Count != 0)
            {
                // The dependencies need to be updated outside the AssetPostprocessor calls.
